...
outline
- difference in results from sampling
- using 100 sample method for LES comparisons
- Both the LES and the BP indicate substantial improvements, with LES indicating that BP may be underpredicting the improvement.
- Low errors for AEP predictions
- overprestimate AEP for base case
- underpredicted AEP for opt case 
...
- Optimized power production in each direction was nearly equal according to BP, more variance in the LES. LES of base case direction had more spread/variation than BP as well.
