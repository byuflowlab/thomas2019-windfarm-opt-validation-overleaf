...
\caption{Model error (in $\%$) as compared to Horn Rev LES data \cite{niayifar2016}}\label{tab:validation-error}
\ra{1.3}
\begin{tabular}{@{}llcrcrrcrrcrr@{}}\toprule
& &\phantom{abc}&  & \phantom{abc} &\multicolumn{2}{c}{No Local TI} &\phantom{abc}& \multicolumn{2}{c}{Hard Max TI} &\phantom{abc}& \multicolumn{2}{c}{Smooth Max TI}\\ 
\cmidrule{6-7} \cmidrule{9-10} \cmidrule{12-13}
& &\phantom{abc}&  &  \phantom{abc} & \multicolumn{2}{c}{Samples} & \phantom{abc}&\multicolumn{2}{c}{Samples} & \phantom{abc}&\multicolumn{2}{c}{Samples}\\ 

& & \phantom{abc}& \multicolumn{1}{c}{NP Model} & \phantom{abc} & \multicolumn{1}{c}{100} & \multicolumn{1}{c}{1} & \phantom{abc} &\multicolumn{1}{c}{100} & \multicolumn{1}{c}{1} & \phantom{abc} & \multicolumn{1}{c}{100} & \multicolumn{1}{c}{1}\\ 
\cmidrule{4-4} \cmidrule{6-7} \cmidrule{9-10} \cmidrule{12-13}

\multicolumn{2}{l}{Directional} & & & & & & & \\
 \phantom{abc} &  \multicolumn{1}{l}{Max} & & & & & & & \\
\phantom{abc} &  \multicolumn{1}{l}{Average} & & & & & & & \\
