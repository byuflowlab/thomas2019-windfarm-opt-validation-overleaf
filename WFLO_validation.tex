...
To remove the discontinuity, we used linear interpolation on both the velocity value and the wake spread. First, the magnitude of the Gaussian curve at $x_d$ was calculated, as in \Cref{eq:gaus-mag}.
%
\begin{equation}\label{eq:gaus-mag}
